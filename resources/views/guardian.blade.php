        ...
        <table class="min-w-full divide-y divide-gray-700">
            <thead class="bg-gray-900/80">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Job</th>
            ...
            <tbody class="bg-gray-800/70 divide-y divide-gray-700 text-gray-200">
                @foreach ($guardian as $index => $user)
                    <tr class="hover:bg-gray-700/60 transition duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">{{ $user['job'] }}</td>
